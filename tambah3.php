...
<meta charset="utf-8">
<title>Data Pengeluaran Elek Shop</title>
...
<h2><font color="black">Data Pengeluaran Elek Shop</h2>
</hgroup><br>
<form class="form-horizontal" action="simpan3.php" enctype="multipart/form-data" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="text" name="jenis" class="form-control" placeholder="Jenis Pengeluaran" required>
					</div></div>
				<div class="form-group">
 ...
 <a href="user4.php"><input type="button" class="btn btn-danger" value="Batal"></a> 
