...
<form class="form-horizontal" action="simpan.php" enctype="multipart/form-data" method="post">
 ...
 <a href="user.php"><input type="button" class="btn btn-danger" value="Batal"></a> 
